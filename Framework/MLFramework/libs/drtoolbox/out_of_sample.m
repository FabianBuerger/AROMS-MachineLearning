...
% (C) Laurens van der Maaten, Delft University of Technology
    ...
    switch mapping.name
        ...
        % Linear mappings
        case {'PCA', 'LDA', 'LPP', 'NPE', 'LLTSA', 'SPCA', 'PPCA', 'FA', 'NCA', 'MCML', 'LMNN', 'FastICA'}
            t_point = bsxfun(@minus, point, mapping.mean) * mapping.M;
            
        case {'Whitening'}
            t_point = whitening_transform(point, mapping);
        ...
        case 'paramtSNE'   
            %t_point = run_data_through_network(mapping.network, point);
            t_point = run_data_through_network_vtsne(mapping.network, point);
        otherwise
