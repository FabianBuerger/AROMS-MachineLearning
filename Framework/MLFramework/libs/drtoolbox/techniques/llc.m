...
% (C) Laurens van der Maaten, Delft University of Technology
    ...
    if condest(A) > 1e5 || condest(B) > 1e5
        %fprintf('NOT GOOD CONDITION for EIGS\n')
...
%     mCondA = condest(A);
%     mCondB = condest(B);                
%     fprintf('Eigen START mCondA= %0.2f   mCondB=%0.2f   no_dims= %d \n',mCondA,mCondB,no_dims);
%     debugData = struct;
%     debugData.A = A;
%     debugData.B = B;
%     debugData.no_dims = no_dims;
%     save('llcdebug.mat','debugData');
