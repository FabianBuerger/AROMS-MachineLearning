% Class definition ClassifierSVMLinear
% 
% This realizes a SVM with a linear kernel and penalty parameter C (CSVM)
% It is based on libSVM
%
% author Fabian Bürger, University Duisburg-Essen

classdef ClassifierSVMLinear < ClassifierAbstract
    %====================================================================
    properties 
    end
    ...
    methods
        ...
        % constructor
        function obj = ClassifierSVMLinear()
            obj.classifierName='SVMLinear';
        end
        ...
        function trainClassifier(this,featureMatrix,targetClasses)
            ...
            paramString = ['-s 0 -t 0 -c ' sprintf('%0.5f',this.classifierParams.C)];
...
%             save(['debug/' fname],'dataDebug');
            ...
            this.classifierModel = svmtrain(targetClasses, featureMatrix, paramString); % linear kernel C-SVM
