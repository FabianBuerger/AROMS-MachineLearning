% Class definition ClassifierSVMPoly
% 
% This realizes a SVM with a polynomial kernel and penalty parameter C (CSVM)
% It is based on libSVM.
%
% author Fabian Bürger, University Duisburg-Essen

classdef ClassifierSVMPoly < ClassifierAbstract
    %====================================================================
    properties 
    end
    ...
    methods
        ...
        % constructor
        function obj = ClassifierSVMPoly()
            obj.classifierName='SVMPoly';
        end
        ...
        function trainClassifier(this,featureMatrix,targetClasses)
            ...
            paramString = ['-s 0 -t 1 -c ' sprintf('%0.5f',this.classifierParams.C) ' -d ' sprintf('%d',this.classifierParams.degree)];    
