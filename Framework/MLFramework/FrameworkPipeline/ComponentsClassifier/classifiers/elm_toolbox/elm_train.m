function [classifierModel, TrainingTime,TrainingAccuracy] = elm_train(featureMatrix,targetClasses, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
...
if Elm_Type~=REGRESSION
    classifierModel.NumberofInputNeurons = NumberofInputNeurons;
    classifierModel.NumberofOutputNeurons = NumberofOutputNeurons;
    classifierModel.InputWeight = InputWeight;
    classifierModel.BiasofHiddenNeurons = BiasofHiddenNeurons;
    classifierModel.OutputWeight = OutputWeight;
    classifierModel.ActivationFunction = ActivationFunction;
    classifierModel.label = label;
    classifierModel.Elm_Type = Elm_Type;    
else
    classifierModel.InputWeight = InputWeight;
    classifierModel.BiasofHiddenNeurons = BiasofHiddenNeurons;
    classifierModel.OutputWeight = OutputWeight;
