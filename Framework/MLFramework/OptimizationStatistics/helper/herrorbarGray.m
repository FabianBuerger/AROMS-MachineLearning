function hh = herrorbarGray(x, y, l, u, symbol)
...
h = plot(xb,yb,esymbol,'Color',pColor,'LineWidth',pThickness); hold on
h = [h;plot(x,y,symbol,'Color',pColor,'LineWidth',pThickness)];
